...
bool MTP40F::setAirPressureReference(int apr) {
  ...
  uint8_t cmd[11] = {0x42, 0x4D, 0xA0, 0x00, 0x01, 0x00,
...
bool MTP40F::setSinglePointCorrection(uint32_t spc) {
  ...
  uint8_t cmd[13] = {0x42, 0x4D, 0xA0, 0x00, 0x04, 0x00, 0x04,
...
bool MTP40F::openSelfCalibration() {
  uint8_t cmd[10] = {0x42, 0x4D, 0xA0, 0x00, 0x06,
...
bool MTP40F::setSelfCalibrationHours(uint16_t hours) {
  ...
  uint8_t cmd[11] = {0x42, 0x4D, 0xA0, 0x00, 0x09, 0x00,
                     0x02, 0x00, 0x00, 0x00, 0x00};
  cmd[7] = hours / 256;
  cmd[8] = hours & 0xFF;
...
//  PROTECTED
//
bool MTP40F::request(uint8_t *data, uint8_t commandLength,
